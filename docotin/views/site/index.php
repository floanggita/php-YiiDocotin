...
<html lang="en"><head>
  ...
  <body>
  <input type="hidden" id="menu" value="transaksi">
  ...
  <div class="sidebar-web-page">
      <ul>
        <a href="keranjang.html"><li data-target="flagging">Keranjang</li></a>
        <a href="transaksi.html"><li data-target="transaksi" class="active">List Pesanan</li></a>
  ...
  <div class="web-content">
    <div class="daftar-menu">
      ...
      <div class="menu">
        <div class="list"> <a href="keranjang.php">
          <img src="../web/images/mie.png" class="menu-pics" alt="">
            <p>Mie Indomie</p>
            <p>Rp. 10.000</p>
          </a>
        </div>
