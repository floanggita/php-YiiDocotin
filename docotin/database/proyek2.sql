...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 22, 2019 at 09:06 AM
...
(4, 'Mie', 10000, '/uploads/barang/Screenshot_2.png', 6, 'Barang Bagus nih', 31),
(5, 'Kebab', 10000, '/uploads/barang/Resep-Kebab.jpg', 1, 'Kebab Hangat dapat di Simpan di Microwave', 31),
(6, 'fdsfsd', 3400, '/uploads/barang/3213212211312321313.png', 3, '1', 31);
...
CREATE TABLE `detailtransaksi` (
  ...
  `jumlah_beli` int(30) DEFAULT NULL,
...
ALTER TABLE `transaksi`
  ...
  ADD KEY `id_user` (`id_user`,`id_verif`);
...
--
ALTER TABLE `detailtransaksi`
  ADD CONSTRAINT `detailtransaksi_ibfk_1` FOREIGN KEY (`id_transaksi`) REFERENCES `transaksi` (`id_transaksi`) ON DELETE SET NULL ON UPDATE SET NULL;

--
-- Constraints for table `detailuser`
--
ALTER TABLE `detailuser`
  ADD CONSTRAINT `detailuser_ibfk_1` FOREIGN KEY (`id_user`) REFERENCES `user` (`id_user`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
